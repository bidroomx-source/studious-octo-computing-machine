...
export default function BidRoom() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans">
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-slate-900 to-[#1e3a5f] text-white py-32">
        <div className="max-w-4xl mx-auto text-center px-6">
          <h2 className="text-6xl font-black mb-6 leading-tight">See Inside. Bid Smart.</h2>
          <p className="text-2xl text-slate-300 mb-10">Transparent room auctions with photos, videos, and live sessions.</p>
          <button onClick={() => setShowSellModal(true)} className="bg-[#c9a227] hover:bg-yellow-400 text-black text-xl font-medium px-12 py-5 rounded-2xl transition">Start Selling Today</button>
        </div>
      </section>
